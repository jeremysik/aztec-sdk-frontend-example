...
export declare class SigningKey {
    ...
    treeIndex: number;
    hashPath: Buffer;
    constructor(accountId: AccountId, key: Buffer, // only contains x coordinate of a grumpkin address.
...
export declare class Alias {
    ...
    latestNonce: number;
    constructor(aliasHash: AliasHash, address: GrumpkinAddress, latestNonce: number);
}
export interface Database extends MutexDatabase {
    ...
    getDefiTxsByNonce(userId: any, interactionNonce: number): Promise<CoreDefiTx[]>;
