...
export interface StabilityPoolBridgeInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "STABILITY_POOL", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "STABILITY_POOL", data: BytesLike): Result;
...
//# sourceMappingURL=StabilityPoolBridge.d.ts.map