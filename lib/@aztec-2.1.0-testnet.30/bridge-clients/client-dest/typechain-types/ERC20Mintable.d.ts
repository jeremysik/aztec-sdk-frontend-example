...
export interface ERC20MintableInterface extends utils.Interface {
    ...
    functions: {
        ...
        "asset_decimals()": FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "asset_decimals", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "asset_decimals", data: BytesLike): Result;
...
export interface ERC20Mintable extends BaseContract {
    ...
    functions: {
        ...
        asset_decimals(overrides?: CallOverrides): Promise<[number]>;
        ...
        mint(_to: string, _value: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    estimateGas: {
        ...
        asset_decimals(overrides?: CallOverrides): Promise<BigNumber>;
        balanceOf(account: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        asset_decimals(overrides?: CallOverrides): Promise<PopulatedTransaction>;
