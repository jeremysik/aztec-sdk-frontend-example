...
export interface ZkATokenInterface extends utils.Interface {
    contractName: "ZkAToken";
    functions: {
    ...
    encodeFunctionData(functionFragment: "setDecimals", values?: undefined): string;
...
export interface ZkAToken extends BaseContract {
    contractName: "ZkAToken";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ZkATokenInterface;
    ...
    functions: {
        ...
        setDecimals(overrides?: CallOverrides): Promise<[number]>;
    ...
    estimateGas: {
        ...
        setDecimals(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        setDecimals(overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=ZkAToken.d.ts.map