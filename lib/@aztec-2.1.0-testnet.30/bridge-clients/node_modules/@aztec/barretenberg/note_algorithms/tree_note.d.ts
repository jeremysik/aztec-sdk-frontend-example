...
export declare class TreeNote {
     ...
     */
    static createFromEphPriv(ownerPubKey: GrumpkinAddress, value: bigint, assetId: number, nonce: number, inputNullifier: Buffer, ephPrivKey: Buffer, grumpkin: Grumpkin, creatorPubKey?: Buffer): TreeNote;
    static createFromEphPub(ownerPubKey: GrumpkinAddress, value: bigint, assetId: number, nonce: number, inputNullifier: Buffer, ephPubKey: GrumpkinAddress, ownerPrivKey: Buffer, grumpkin: Grumpkin, creatorPubKey?: Buffer): TreeNote;
